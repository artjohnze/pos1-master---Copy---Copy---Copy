...
=======
-- Generation Time: Oct 13, 2025 at 12:45 PM
...
(44, 'Biogesic', 'Paracetamol', 'Pain reliever', '', '', '100', '', 'Supplier', 0, 99, 0, 1, '2025-10-13', '2025-10-13 02:41:56');
>>>>>>> 7afa611c0227699da662c76ad192913c471abc9f
...
(24, '616914', '44', '1', '100', '', 'Biogesic', 'Paracetamol', '', '100', '0', '10/13/25');
>>>>>>> 7afa611c0227699da662c76ad192913c471abc9f
...
--
ALTER TABLE `collection` ADD PRIMARY KEY (`transaction_id`);
...
--
ALTER TABLE `sales_order` ADD PRIMARY KEY (`transaction_id`);
...
--
ALTER TABLE `supliers` ADD PRIMARY KEY (`suplier_id`);

--
-- Indexes for table `supplier_deliveries`
--
ALTER TABLE `supplier_deliveries` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `temporary_cart` ADD PRIMARY KEY (`transaction_id`);

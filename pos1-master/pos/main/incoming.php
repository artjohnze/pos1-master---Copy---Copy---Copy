...
// query
$sql = "INSERT INTO sales_order (invoice,product,qty,amount,price,profit,product_code,gen_name,date) VALUES (:a,:b,:c,:d,:f,:h,:i,:j,:k)";
$q = $db->prepare($sql);
$q->execute(array(':a' => $a, ':b' => $b, ':c' => $c, ':d' => $d, ':f' => $asasa, ':h' => $profit, ':i' => $code, ':j' => $gen, ':k' => $date));

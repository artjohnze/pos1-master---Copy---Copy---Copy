...
<?	<link href="css/bootstrap.css" rel="stylesheet">
	...
	<link rel="stylesheet" type="text/css" href="css/DT_bootstrap.css">e_once('auth.php');
?>
				...
				<div class="content" id="content">
					<div style="font-weight:bold; text-align:center;font-size:14px;margin-bottom: 15px;">
						...
						if (isset($_GET['d1']) && isset($_GET['d2']) && $_GET['d1'] != '' && $_GET['d2'] != '' && $_GET['d1'] != '0' && $_GET['d2'] != '0') {
							echo "Sales Report from&nbsp;" . $_GET['d1'] . "&nbsp;to&nbsp;" . $_GET['d2'];
						} else {
							echo "All Sales Report";
						}
						?>
					</div>
					<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
						...
						<tbody>
							...
							// Check if dates are provided, if not show all records
							if (isset($_GET['d1']) && isset($_GET['d2']) && $_GET['d1'] != '' && $_GET['d2'] != '' && $_GET['d1'] != '0' && $_GET['d2'] != '0') {
								// Use provided dates
								$d1 = $_GET['d1'];
								$d2 = $_GET['d2'];
								...
								$dateCondition = "WHERE date BETWEEN '$d1' AND '$d2'";
							} else {
								// Show all records
								$d1 = '';
								$d2 = '';
						...
						<thead>
							<tr>
								...
								<th colspan="1" style="border-top:1px solid #999999">
									<?php
									// Calculate totals based on whether dates are provided
									if (isset($_GET['d1']) && isset($_GET['d2']) && $_GET['d1'] != '' && $_GET['d2'] != '' && $_GET['d1'] != '0' && $_GET['d2'] != '0') {
										$d1 = $_GET['d1'];
										$d2 = $_GET['d2'];
